# ============================================================================
# Phase 4: Document Migration — PREVIEW / DRY RUN (v4)
# ============================================================================
# Shows what files exist in HTTHQ source and where they'd go in DCE
# Uses Interactive auth for httbrands (no device code needed for source)
# ============================================================================

$ErrorActionPreference = "Stop"

# Source: HTTHQ (httbrands tenant) — use Interactive auth
$sourceUrl = "https://httbrands.sharepoint.com/sites/HTTHQ"

# Dest: DCE (deltacrown tenant) — DeviceLogin
...
# ============================================================================
# AUTH 1: Source (httbrands) — Interactive browser
# ============================================================================
Write-Host "`n$('=' * 60)" -ForegroundColor Cyan
Write-Host "  AUTH: HTTHQ Source (httbrands)" -ForegroundColor Cyan
Write-Host "  Browser window will open for sign-in..." -ForegroundColor Yellow
Write-Host "$('=' * 60)" -ForegroundColor Cyan

Connect-PnPOnline -Url $sourceUrl -Interactive -ErrorAction Stop
Write-Log "Connected: HTTHQ Source" "SUCCESS"
...
# ============================================================================
# AUTH 2: Dest (deltacrown) — DeviceLogin
# ============================================================================
Write-Host "`n$('=' * 60)" -ForegroundColor Cyan
Write-Host "  AUTH: DCE Admin (deltacrown)" -ForegroundColor Cyan
Write-Host "  Tyler: code at https://microsoft.com/devicelogin" -ForegroundColor Yellow
Write-Host "$('=' * 60)" -ForegroundColor Cyan

Connect-PnPOnline -Url "https://deltacrown-admin.sharepoint.com" -DeviceLogin -ClientId $destClientId -Tenant $destTenantId -ErrorAction Stop
Write-Log "Connected: DCE Admin" "SUCCESS"
...
Write-Log "This preview is historical planning context only." "INFO"
