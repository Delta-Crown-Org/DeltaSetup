...
if (-not $WhatIf) {
    ...
    Update-MgPolicyCrossTenantAccessPolicyPartner @syncParams -ErrorAction SilentlyContinue
...
if (-not $WhatIf) {
    ...
    Update-MgPolicyCrossTenantAccessPolicyPartner @redemptionParams -ErrorAction SilentlyContinue
...
if (-not $WhatIf) {
    ...
    Update-MgPolicyCrossTenantAccessPolicyPartner @outboundParams -ErrorAction SilentlyContinue
